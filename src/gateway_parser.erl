		...
		3 ->
			...
			Adm = case tk_maps:get([<<"creative">>, <<"class">>], RSP0) of
					  <<"html5">> ->
						  ...
						  Link = <<"%%CLICK_URL_UNESC%%", ClickTagEsc/binary>>,
						  <<"<a href='javascript:void(0)' onclick='window.open(\"", Link/binary, "\", \"_blank\")'>
						  <iframe src='", Html0/binary, "' marginwidth='0' marginheight='0' align='top' scrolling='no' frameborder='0'"
							  , "hspace='0' vspace='0' height='", H/binary, "' width='", W/binary, "'></iframe>
							  <img  width='1' height='1' style='border:0; visibility: hidden;' src='", ImpPath/binary, "'></a>">>;
					  <<"banner">> ->
